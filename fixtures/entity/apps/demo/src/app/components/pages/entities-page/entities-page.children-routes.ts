...
import { TestEntitiesFrameRoutes } from './test-entities-frame/test-entities-frame.routes';
...
export const EntitiesPageChildrenRoutes = [
  { path: '', redirectTo: '/entities/content-types', pathMatch: 'full' },
  {
    ...
    path: 'test-entities',
    loadChildren: './test-entities-frame/test-entities-frame.module#TestEntitiesFrameModule',
    data: TestEntitiesFrameRoutes[0].data
  }, {
    path: 'users',
