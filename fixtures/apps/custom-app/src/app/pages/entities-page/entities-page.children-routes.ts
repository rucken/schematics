...
import { CUSTOM_ENTITIES_FRAME_ROUTES } from './custom-entities-frame/custom-entities-frame.routes';
...
export const ENTITIES_PAGE_CHILDREN_ROUTES = [
  ...
  },
  {
    ...
    loadChildren:
      './custom-entities-frame/custom-entities-frame.module#CustomEntitiesFrameModule',
    data: CUSTOM_ENTITIES_FRAME_ROUTES[0].data
  }
];
