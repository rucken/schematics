...
if (connectionString.protocol === 'sqlite') {
    module.exports = {
        ...
        entities: projects.map(lib => `${lib.sourceRoot}/**/entities/**/*.entity.ts`),
        migrations: projects.map(lib => `${lib.sourceRoot}/**/migrations/**/*.ts`),
        subscribers: projects.map(lib => `${lib.sourceRoot}/**/subscribers/**/*.ts`),
        logging: 'all',
        synchronize: false,
        cli: {
