 ...
 */
export function updateJsonFile(localPath: string, callback: (a: any) => any) {
 ...
 * @param localPath Path of the JSON file on the filesystem
 */
export function readJsonFile<T = any>(localPath: string): T {
  return JSON.parse(fs.readFileSync(localPath, 'utf-8'));
}

export function writeJsonFile(localPath: string, json: any) {
